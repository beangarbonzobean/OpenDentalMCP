...
def _ollama_ocr_call(
    ...
    *,
    ...
    body = {
        ...
        # >= a few seconds keeps the model warm across docs. The cold-load
        # GGML_ASSERT this used to amortize is now handled by the circuit
        # breaker + tighter first-attempt timeout in this file.
